...
<div class='row'>
    <div class='col-md-12'><br>
        ...
        <table class='table table-striped table-sm' id='cursos'></table>
    </div>
</div>
    ...
    $(document).ready(function getCursos(){
        ...
        xhttp.onreadystatechange = function() {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(resultado != null){
                    resultado.forEach(x => {
                        lista += "<tr><td>"+ x.nome_curso +"</td><td>"+ x.carga_horaria + "</td><td><button onclick=\"excluirCurso("+ x.cod_curso +")\" class='btn btn-link btn-sm'><i class='fa fa-trash'></i></button> <button onclick=\"editarCurso("+ x.cod_curso +")\" class='btn btn-link btn-sm'><i class='fa fa-edit'></i></button></td></tr>";
                    });                
