    ...
    $(document).ready(function getMaterias(){
        ...
        xhttp.onreadystatechange = function() {            
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(resultado != null){
                    resultado.forEach(x => {
                        lista += "<tr><td>"+ x.nome_materia +"</td><td>"+ x.carga_horaria + "</td><td><button onclick=\"excluirMateria("+ x.cod_materia +")\" class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></button> <button onclick=\"editarMateria("+ x.cod_materia +")\" class='btn btn-success btn-sm'><i class='fa fa-edit'></i></button></td></tr>";
                    });                
